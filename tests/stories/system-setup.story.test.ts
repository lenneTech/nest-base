...
import { SystemSetupService, type AdminProvisioningStorage } from '../../src/core/setup/system-setup.service.js';
...
describe('Story · System-Setup (Initial-Admin)', () => {
  function makeStorage(initial: { email: string }[] = []): AdminProvisioningStorage & { records: Set<string>; calls: number } {
