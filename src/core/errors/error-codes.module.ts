...
function seedCoreCodes(registry: ErrorCodeRegistry): void {
  ...
  registry.register({
    ...
    messages: {
      ...
      de: { title: 'Validierungsfehler', detail: 'Die Anfrage hat die Validierung nicht bestanden.' },
    },
  });
  registry.register({
  ...
  registry.register({
    ...
    messages: {
      ...
      de: { title: 'Zu viele Anfragen', detail: 'Rate-Limit erreicht; bitte später erneut versuchen.' },
    },
  });
}
