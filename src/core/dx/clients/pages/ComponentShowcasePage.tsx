  ...
  return (
    <ToastProvider>
      <header className="dp-header">
        <div>
          <h1 className="dp-header__title">Components</h1>
          <p className="dp-header__subtitle">
            Living style guide for every react-aria-components primitive used by the Dev-Portal.
          </p>
        </div>
      </header>

      <section className="dp-card">
        <h2 className="dp-card__title">Buttons</h2>
      ...
      <section className="dp-card">
        <h2 className="dp-card__title">Inputs</h2>
        <div className="dp-component-row">
          <TextField
            label="Name"
            value={textValue}
      ...
      <section className="dp-card">
        <h2 className="dp-card__title">Toggles</h2>
        <div className="dp-component-row">
      ...
      <section className="dp-card">
        <h2 className="dp-card__title">Pickers</h2>
        <div className="dp-component-row">
      ...
      <section className="dp-card">
        <h2 className="dp-card__title">Dialog · Toast · Menu · Tooltip</h2>
        <div className="dp-component-row">
      ...
      <section className="dp-card">
        <h2 className="dp-card__title">Tabs</h2>
        <Tabs>
      ...
      <section className="dp-card">
        <h2 className="dp-card__title">FileTrigger</h2>
        <div className="dp-component-row">
          <FileTrigger
